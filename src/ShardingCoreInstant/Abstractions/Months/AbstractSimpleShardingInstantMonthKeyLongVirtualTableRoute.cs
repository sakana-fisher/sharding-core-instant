...
{
    public abstract class AbstractSimpleShardingInstantMonthKeyLongVirtualTableRoute<TEntity> : AbstractShardingInstantKeyLongVirtualTableRoute<TEntity> where TEntity : class
    {
